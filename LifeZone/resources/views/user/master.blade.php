        ...
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-8">
                <ul class="top-header-contact-info">
                    <li>
                        Call: 
                        <a href="tel:502464674">+01502464674</a>
                    </li>
                </ul>
            ...
            <div class="raque-responsive-menu">
                <div class="logo">
                    <a href="index.html">
                        ...
                        <img src="{{ asset('frontend/assets/img/lifezone1.2-removebg-preview.png')}}" width="60" class="white-logo" alt="logo">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-md navbar-light">
                <a class="navbar-brand" href="index.html">
                    <img src="{{ asset('frontend/assets/img/lifezone1.2-removebg-preview.png')}}" width="60" class="black-logo" alt="logo">
                    <img src="{{ asset('frontend/assets/img/lifezone1.2-removebg-preview.png')}}" width="60" class="white-logo" alt="logo">
                </a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <img src="{{ asset('frontend/assets/img/lifezone1.3.png')}}" alt="" width="100">
                        <p class="textAlignment" >Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Proin eget tortor risus. Praesent sapien massa, convallis a pellentesque nec, egestas non nisi. </p>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="single-footer-widget mb-30">
                            ...
                            <ul class="contact-us-link">
                                <li>
                                    <i class='bx bx-map'></i>
                                    <a href="#" target="_blank">Main Branch House # 55/2, Union Heights, Level # 6 & 14, West Panthapath, Dhaka-1205, Bangladesh.</a>
                                </li>
                                <li>
                                    <i class='bx bx-phone-call'></i>
                                    <a href="#">+011 (123) 456 7890</a>
                                </li>
                                <li>
                                    <i class='bx bx-envelope'></i>
                                    <a href="#"><span class="__cf_email__" data-cfemail="a9c1ccc5c5c6e9dbc8d8dccc87cac6c4">[email&#160;protected]</span></a>
                                </li>
                            </ul>
